        ...
        <li className="p-2 border-bottom" style={{ backgroundColor: "#eee" }}>
          ...
          >
            <div className="d-flex flex-row">
              ...
              />
              <div className="pt-1">
                <p className="fw-bold mb-0">{message.userId}</p>
                <p className="small text-muted">{message.body}</p>
              </div>
            </div>
            <div className="pt-1">
              <p className="small text-muted mb-1">{message.lastUpdate}</p>
            </div>
          </a>
        </li>
      );
    ...
    <>
      ...
      <MDBContainer fluid className="py-5" style={{ backgroundColor: "#eee" }}>
        <MDBRow>
          ...
          <MDBCol md="6" lg="7" xl="8">
            <MDBTypography listUnStyled>{dmChat}</MDBTypography>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
    </>
