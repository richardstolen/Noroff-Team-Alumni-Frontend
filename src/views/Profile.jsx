...
function Profile({ user_id }) { 
  ...
  if (!user) {
    ...
    if (!KeyCloakService.GetId()) {  //=== searchedUser.userId legge til dette
      return (
      ...
      return (
        <div className="text-center text-muted mb-4">
          ...
          <div className="d-flex justify-content-center align-items-center mb-4" style={{ color: '#666' }}>
          <h4 className="mb-0 mr-2" style={{ lineHeight: '1.5' }}>{user.status}&nbsp;&nbsp;</h4>
            <div className="d-flex align-items-center">
              <button onClick={handleStatusEdit} className="material-icons text-red-600 text-5xl">edit</button>
              <div className="ml-2">Edit status</div>
            </div>
          </div>

          <div className="d-flex justify-content-center align-items-center mb-4" style={{ color: '#666' }}>
          <h4 className="mb-0 mr-2" style={{ lineHeight: '1.5' }}>{user.bio}&nbsp;&nbsp;</h4>
            <div className="d-flex align-items-center">
              <button onClick={handleBioEdit} className="material-icons text-red-600 text-5xl">edit</button>
              <div className="ml-2">Edit bio</div>
            </div>
          </div>

          <div className="d-flex justify-content-center align-items-center mb-4" style={{ color: '#666' }}>
          <h4 className="mb-0 mr-2" style={{ lineHeight: '1.5' }}>{user.funFact}&nbsp;&nbsp;</h4>
            <div className="d-flex align-items-center">
              <button onClick={handleFunFactEdit} className="material-icons text-red-600 text-5xl">edit</button>
